<table class="data_table">
    <tr>
        ...
        <td>
            <span class="code">&nbsp;Code: &#35;#select->[name=select1;text=&#123;data::text_test1&#125;;value=&#123;data::text_test1&#125;]#&#35;</span>
        </td>
    </tr>
    <tr>
        <td>##select->[name=select2;text=$[|i18n::text|,2,3,4,5,6];value=$[|config::app_path|,w,e,r,t,y]]##</td>
        <td>
            <span class="code">&nbsp;Code: &#35;#select->[name=select2;text=$[|i18n::text|,2,3,4,5,6];value=$[|config::app_path|,w,e,r,t,y]]#&#35;</span>
        </td>
    </tr>
    <tr>
        <td>##select->[name=select3;text=$[1];value=$[1];id=test_id;class=test_class;style=width:150px;]##</td>
        <td>
            <span class="code">&nbsp;Code: &#35;#select->[name=select3;text=$[1];value=$[1];id=test_id;class=test_class;style=width:150px;]#&#35;</span>
        </td>
    </tr>
    <tr>
        <td>##select->[name=select4;selected=2;text=$[test1,test2];value=$[1,2];js=onChange:alert(123);]##</td>
        <td>
            <span class="code">&nbsp;Code: &#35;#select->[name=select4;selected=2;text=$[test1,test2];value=$[1,2];js=onChange:alert(123);]#&#35;</span>
        </td>
    </tr>
</table>
