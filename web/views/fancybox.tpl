<table class="data_table">
    ...
    <tr>
        <td>
            ##fancybox->[title=test map;file={map};type=map]##
        </td>
        <td>
            <span class="code">&nbsp;Code: &#35;#fancybox->[title=test map;file=&#123;map&#125;;type=map]#&#35;</span>
        </td>
    </tr>
    <tr>
        <td>
            ##fancybox->[title=test iframe;file=http://i.ua/;type=iframe]##
        </td>
        <td>
            <span class="code">&nbsp;Code: &#35;#fancybox->[title=test iframe;file=http://i.ua/;type=iframe]#&#35;</span>
        </td>
    </tr>
    <tr>
        <td>
            ##fancybox->[title=test ajax;file=/ui/checkbox;type=ajax]##
        </td>
        <td>
            <span class="code">&nbsp;Code: &#35;#fancybox->[title=test ajax;file=/ui/checkbox;type=ajax]#&#35;</span>
        </td>
    </tr>
</table>